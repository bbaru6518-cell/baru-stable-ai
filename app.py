...
【買い目は必ず以下の形式のみで出力せよ。余計な説明・複数フォーメーション・穴狙い別フォーメーションは禁止。】
...
三連複フォーメーション:
1着: 5 カーボフリオ
2着: 7 エリースノー　3 サンダースノー
3着: 9 ルクリーシア　12 ロンバスブレス　11 テンハートビート　14 フィーユレアル

※1着・2着・3着の各列は改行して明確に区切ること。
※買い目の総点数を最後に「合計〇点」と記載すること。
※根拠は3行以内の箇条書きで簡潔に添えること。
"""
